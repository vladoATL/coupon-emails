...
<?php  echo wc_help_tip(__( 'Add multiple emails separated by comma ( , ).', 'coupon-emails' ) . ' ' . __( 'Settings of other filters will be ignored if not empty.', 'coupon-emails'  ), false); ?>
	...
	?>
				<input type="text" id="onetimeemail_options[coupon_cat]" name="onetimeemail_options[coupon_cat]"  style="width: 200px;" value="<?php echo $options['coupon_cat'] ?? ''; ?>"
				<?php echo $acfw; ?>>
...
<p>
	<input type="button" value="<?php echo  __( 'Create a test', 'coupon-emails' ); ?>" class="button button-primary" attr-nonce="<?php echo esc_attr( wp_create_nonce( '_onetime_nonce_test' ) ); ?>" id="test_onetime_btn" />

	...
	<table class="widefat striped" width="100%">
		<thead>
			<tr>
				...
				<th width="20%" class="column-posts title-center"><?php echo __( 'Active coupons', 'coupon-emails' ); ?></th>
				<th width="20%" class="column-posts title-center"><?php echo __( 'Used coupons', 'coupon-emails' ); ?></th>
				<th width="20%" class="column-posts title-center"><?php echo __( 'Unused coupons', 'coupon-emails' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php
			...
			<tr>
				...
				<td class="manage-column num"><?php echo $row->notexpired_count; $active += $row->notexpired_count; ?></td>
				<td class="manage-column num"><?php echo $row->used_count; $used += $row->used_count; ?></td>
				<td class="manage-column num"><?php echo $row->expired_count; $expired += $row->expired_count; ?></td>					
			</tr>
			<?php } 				?>
		</tbody>
		<tfoot>
			<tr>
				...
				<td class="manage-column num"><?php echo $active; ?></td>
				<td class="manage-column num"><?php echo $used; ?></td>				
				<td class="manage-column num"><?php echo $expired; ?></td>
			</tr>
		</tfoot>
	</table>	
</div>
